...
public:
	...
	uint8_t requestFrom(uint8_t, uint8_t, uint32_t, uint8_t); // NEW: Added from https://github.com/arduino/Arduino/issues/2428
...
extern TwoWire DueWire;
#endif
#if WIRE_INTERFACES_COUNT > 1
extern TwoWire DueWire1;
#endif
